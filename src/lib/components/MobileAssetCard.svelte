<script lang="ts">
	...
	let { asset, assetUrl, pairedMode = null, drawerOptions }: Props = $props();
...
<div class="mobile-asset-card-wrapper">
	<div class="mobile-asset-card">
		<div class="mobile-asset-image-wrapper">
			...
			<button onclick={toggleDrawer} class="elipsis" aria-label="More button">
				<svg
